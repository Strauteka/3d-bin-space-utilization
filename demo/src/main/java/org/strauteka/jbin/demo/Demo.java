...
public class Demo {
    ...
    public static void drawRotations() {
        final List<Container> bins = new ArrayList<>();
        ...
        Draw3d.draw(true, false, 1200, 800, colors, bins.toArray(new Container[0]));
    }
    ...
    public static Container test4() {
        return new Container(1000, 1000, 1000).add(new Cargo<Size>(new Size(700, 200, 200), new Size(0, 0, 0)))
    ...
    public static Container test6() {
        return new Container(1000, 1000, 1000)
                .add(new Cargo<Size>(new Size(100, 50, 50), 4, 8, 2, new Size(300, 300, 300)))
    ...
    public static Container test7() {
        ...
        return new Container(new Size(1000, 1000, 1000)).add(new Cargo<Pallet>(pallet, new Size(400, 0, 0)))
                .add(new Cargo<Pallet>(pallet, Rotation.whl, new Size(0, 0, 0)));
    }

    public static Container test8() {
        return new Container(1000, 1000, 1000).add(new Cargo<Size>(new Size(300, 200, 400), new Size(150, 0, 150)))
